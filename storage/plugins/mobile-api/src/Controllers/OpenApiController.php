        ...
        return [
            ...
            '/catalog/search' => [
                'get' => [
                    ...
                    'security'    => [['bearerAuth' => []]],
                    'parameters'  => [
                        ['name' => 'q',         'in' => 'query', 'schema' => ['type' => 'string'], 'description' => 'Weighted full-text search (ISBN/EAN, title, author, subtitle, publisher, keywords, description)'],
                        ...
                        ['name' => 'sort',      'in' => 'query', 'schema' => ['type' => 'string', 'enum' => ['relevance', 'newest', 'oldest', 'title_asc', 'title_desc', 'author_asc', 'author_desc']], 'description' => 'Sort order. Text queries default to relevance; facet-only browsing defaults to newest.'],
    ...
    private function loanItemSchema(): array
    {
        return [
            ...
            'properties' => [
                ...
                'requested_at' => ['type' => 'string', 'format' => 'date', 'nullable' => true, 'description' => 'Date the loan request was created (since 1.4.3). The honest date for cancelled/expired loans, which never went out.'],
