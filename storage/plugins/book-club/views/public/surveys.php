  ...
  <?php if ($canManage && $grouped['draft'] !== []): ?>
    <section class="bg-white rounded-xl shadow p-6 mb-8">
      ...
      <?php foreach ($grouped['draft'] as $survey): ?>
        <div class="border border-dashed rounded-lg px-4 py-3 mb-3 flex flex-wrap items-center justify-between gap-3">
          <div>
          ...
          <a href="<?= $e($base . '/' . (int) $survey['id']) ?>" class="inline-flex items-center px-3 py-1.5 text-xs bg-gray-900 hover:bg-gray-800 text-white rounded-lg">
