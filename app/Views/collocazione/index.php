          ...
          <div>
            ...
            <div class="space-y-2 text-sm text-gray-600">
              ...
              <div class="ml-6 text-xs space-y-1">
                ...
                <div>• <strong>2</strong> = Mensola 2</div>
                <div>• <strong>15</strong> = Posizione 15</div>
              </div>
            </div>
          </div>
                    ...
                    <li class="p-4 hover:bg-gray-50 transition-colors cursor-move" data-id="<?php echo (int)$s['id']; ?>">
                      <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                          ...
                          <form method="post" action="/admin/collocazione/scaffali/<?php echo (int)$s['id']; ?>/delete" class="inline" onsubmit="return confirm('Eliminare questo scaffale? (Solo se vuoto)');">
                            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars(App\Support\Csrf::ensureToken(), ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <li class="p-4 hover:bg-gray-50 transition-colors cursor-move" data-id="<?php echo (int)$m['id']; ?>">
                      <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                          ...
                          <form method="post" action="/admin/collocazione/mensole/<?php echo (int)$m['id']; ?>/delete" class="inline" onsubmit="return confirm('Eliminare questa mensola? (Solo se vuota)');">
                            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars(App\Support\Csrf::ensureToken(), ENT_QUOTES, 'UTF-8'); ?>">
                            <button type="submit" class="text-red-600 hover:text-red-800 text-sm" title="Elimina"><i class="fas fa-trash"></i></button>
                          </form>
                        </div>
              ...
              <div class="max-h-96 overflow-y-auto">
                <table class="w-full text-sm" id="collocation-table">
                  <thead class="bg-gray-50 border-b border-gray-200 sticky top-0">
                    <tr>
                      <th class="px-4 py-2 text-left font-semibold text-gray-700">Collocazione</th>
                      <th class="px-4 py-2 text-left font-semibold text-gray-700">Titolo</th>
                      <th class="px-4 py-2 text-left font-semibold text-gray-700">Autori</th>
                      <th class="px-4 py-2 text-left font-semibold text-gray-700">Editore</th>
                      <th class="px-4 py-2 text-center font-semibold text-gray-700">Azioni</th>
                    </tr>
                  </thead>
