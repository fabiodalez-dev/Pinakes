        ...
        <div class="card-body form-section">
          <div class="form-grid-2">
            <div>
              ...
              <input id="nome" name="nome" required aria-required="true" class="form-input" placeholder="Nome della casa editrice" />
            </div>
            <div>
              <label for="sito_web" class="form-label">Sito Web</label>
              <input id="sito_web" name="sito_web" type="url" class="form-input" placeholder="https://www.editore.com" />
          ...
          <div class="form-grid-2">
            <div>
              ...
              <input id="email" name="email" type="email" class="form-input" placeholder="info@editore.com" />
            </div>
            <div>
              <label for="telefono" class="form-label">Telefono</label>
              <input id="telefono" name="telefono" type="tel" class="form-input" placeholder="+39 02 1234567" />
            </div>
          </div>

          <div>
            <label for="indirizzo" class="form-label">Indirizzo</label>
            <textarea id="indirizzo" name="indirizzo" rows="3" class="form-input" placeholder="Via Roma 123, 00100 Roma RM, Italia"></textarea>
          </div>
        </div>
      </div>
        ...
        <div class="card-body form-section">
          <div class="form-grid-3">
            <div>
              ...
              <input id="referente_nome" name="referente_nome" class="form-input" placeholder="Nome e cognome del referente" />
            ...
            <div>
              ...
              <input id="referente_telefono" name="referente_telefono" type="tel" class="form-input" placeholder="+39 02 1234567" />
            </div>
            <div>
              <label for="referente_email" class="form-label">Email Referente</label>
              <input id="referente_email" name="referente_email" type="email" class="form-input" placeholder="referente@editore.com" />
            </div>
          </div>

          <div>
            <label for="codice_fiscale" class="form-label">Codice Fiscale</label>
            <input id="codice_fiscale" name="codice_fiscale" type="text" maxlength="16" class="form-input" placeholder="es. RSSMRA80A01H501U" />
