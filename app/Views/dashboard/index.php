    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm mb-8">
      <div class="p-6 border-b border-gray-200 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
          <a href="<?= htmlspecialchars($icsUrl ?? url('/calendar/events.ics'), ENT_QUOTES, 'UTF-8') ?>" class="inline-flex items-center px-3 py-1.5 text-sm bg-gray-800 text-white hover:bg-gray-700 rounded-lg transition-colors duration-200 whitespace-nowrap">
              ...
              <div class="px-5 pb-5">
                ...
                <?php else: ?>
                  <div class="flex gap-3">
                    <button type="button" class="inline-flex items-center justify-center flex-1 bg-gray-800 hover:bg-gray-700 text-white font-medium py-2.5 px-4 rounded-lg transition-colors confirm-pickup-btn" data-loan-id="<?= (int)$loan['id']; ?>">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm mb-8">
      <div class="p-6 border-b border-red-200 bg-red-50 flex flex-col md:flex-row items-center justify-between gap-4 rounded-t-xl">
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="<?= htmlspecialchars(url('/admin/loans'), ENT_QUOTES, 'UTF-8') ?>" class="inline-flex items-center px-4 py-2 text-sm bg-gray-800 text-white hover:bg-gray-700 rounded-lg transition-colors duration-200 whitespace-nowrap font-medium">
            <i class="fas fa-external-link-alt mr-1"></i>
            <?= __("Gestisci") ?>
          </a>
        </div>
