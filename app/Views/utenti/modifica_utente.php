...
<div class="py-8">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8">
      <h1 class="text-2xl font-semibold text-gray-900">Modifica utente</h1>
      <p class="text-sm text-gray-500 mt-1">Aggiorna le informazioni del profilo selezionato.</p>
    </div>
    ...
    <form action="/admin/utenti/update/<?= $utenteId; ?>" method="post" class="space-y-6" id="user-form">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          <div>
            ...
            <select id="tipo_utente" name="tipo_utente" class="mt-1 block w-full rounded-md border-gray-300 focus:border-gray-900 focus:ring-gray-900">
              <option value="standard" <?= $ruolo === 'standard' ? 'selected' : ''; ?>>Standard</option>
              <option value="premium" <?= $ruolo === 'premium' ? 'selected' : ''; ?>>Premium</option>
              <option value="staff" <?= $ruolo === 'staff' ? 'selected' : ''; ?>>Staff</option>
              <option value="admin" <?= $ruolo === 'admin' ? 'selected' : ''; ?>>Amministratore</option>
            </select>
      ...
      <section class="bg-white border border-gray-200 rounded-lg p-6 space-y-4">
        ...
        <div data-admin-hide>
          ...
          <textarea id="indirizzo" name="indirizzo" rows="3" class="mt-1 block w-full rounded-md border-gray-300 focus:border-gray-900 focus:ring-gray-900" placeholder="Via, numero civico, città, CAP"><?= $indirizzo; ?></textarea>
        </div>
        <div data-admin-hide>
          <label for="cod_fiscale" class="block text-sm font-medium text-gray-700">Codice Fiscale</label>
          <input type="text" id="cod_fiscale" name="cod_fiscale" maxlength="16" value="<?= $cod_fiscale; ?>" class="mt-1 block w-full rounded-md border-gray-300 focus:border-gray-900 focus:ring-gray-900" placeholder="es. RSSMRA80A01H501U" style="text-transform: uppercase;">
      ...
      <section class="bg-white border border-gray-200 rounded-lg p-6 space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <input type="text" id="telefono" name="telefono" value="<?= $telefono; ?>" class="mt-1 block w-full rounded-md border-gray-300 focus:border-gray-900 focus:ring-gray-900" placeholder="+39 123 456 7890">
        ...
        <div>
          ...
          <input type="password" autocomplete="new-password" id="password" name="password" class="mt-1 block w-full rounded-md border-gray-300 focus:border-gray-900 focus:ring-gray-900" placeholder="Lascia vuoto per non modificare">
        </div>
      </section>
      ...
      <section class="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <textarea id="note_utente" name="note_utente" rows="3" class="mt-1 block w-full rounded-md border-gray-300 focus:border-gray-900 focus:ring-gray-900" placeholder="Informazioni utili per il personale"><?= $note; ?></textarea>
      </section>
