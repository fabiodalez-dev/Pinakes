    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="flex justify-center items-center gap-2">
                <p class="mb-0"><?= date('Y') ?> • <?= HtmlHelper::e($appName) ?> • <a href="https://github.com/fabiodalez-dev/Pinakes" target="_blank" rel="noopener noreferrer" title="GitHub" aria-label="Pinakes GitHub" class="hover:underline" style="color: inherit;"><i class="fa-brands fa-github"></i> Powered by Pinakes
                    v<?= HtmlHelper::e($appVersion) ?></a></p>
