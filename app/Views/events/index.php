  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div>
          <a href="/admin/cms/events/create" class="inline-flex items-center gap-2 px-5 py-3 bg-gray-900 text-white rounded-xl hover:bg-gray-700 transition-colors font-semibold shadow-sm">
    ...
    <?php if (empty($events)): ?>
      <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 text-center">
        ...
        <p class="text-gray-600 mb-6"><?= __("Non hai ancora creato nessun evento. Inizia creando il tuo primo evento.") ?></p>
        <a href="/admin/cms/events/create" class="inline-flex items-center gap-2 px-5 py-3 bg-gray-900 text-white rounded-xl hover:bg-gray-700 transition-colors font-semibold">
          <i class="fas fa-plus"></i>
              ...
              <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-start justify-between gap-4 mb-3">
                    ...
                    <div class="flex-shrink-0">
                      <?php if ($event['is_active']): ?>
                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-green-100 text-green-800 text-xs font-semibold">
                          <i class="fas fa-check-circle"></i>
                          <?= __("Attivo") ?>
                        </span>
                      <?php else: ?>
                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gray-100 text-gray-800 text-xs font-semibold">
                  ...
                  <div class="flex flex-wrap items-center gap-3 mt-4">
                    <a
                      href="/admin/cms/events/edit/<?= $event['id'] ?>"
