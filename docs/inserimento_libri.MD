...
#### 1⃣ Libreria Universitaria (Fonte Primaria)
...
#### 2⃣ Open Library (Fonte Secondaria)
...
#### 3⃣ Google Books (Fonte di Backup)
...
#### 4⃣ Amazon (Fonte Aggiuntiva Copertine)
...
#### 5⃣ Z39 Server / SRU — Biblioteche Nazionali (Plugin)
