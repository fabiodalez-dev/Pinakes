...
Il Sistema Biblioteca è progettato per essere **multilingua**, il che significa che può essere facilmente tradotto in diverse lingue. Questa guida spiega come funziona il sistema di internazionalizzazione (spesso abbreviato in **i18n**).
