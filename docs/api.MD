# 🔌 API Documentation - Sistema Biblioteca

> **Technical Documentation for Developers**
> Complete reference for all REST API endpoints available in the Sistema Biblioteca CMS.
...
**Loan States**:
```
richiesto      → Request pending admin approval
approvato      → Request approved, awaiting pickup
